...
public final class Constants {
    ...
    public static final double DRIVETRAIN_WHEEL_DIAMETER_METERS = 0.10033;

    public static final double DRIVETRAIN_STEER_GEAR_RATIO = 1 / ((15.0 / 32.0) * (10.0 / 60.0));
    public static final double DRIVETRAIN_DRIVE_GEAR_RATIO = 1 / ((14.0 / 50.0) * (25.0 / 19.0) * (15.0 / 45.0));

    public static final double DRIVETRAIN_STEER_ENCODER_RATIO = 1.0;
    public static final double DRIVETRAIN_DRIVE_ENCODER_RATIO = 1 / ((14.0 / 50.0) * (25.0 / 19.0) * (15.0 / 45.0));
